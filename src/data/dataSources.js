const dataSources = {
    geral: [
        ...
        },
        {
            ...
            link: "https://www.ipardes.pr.gov.br/Pagina/Base-de-Dados-do-Estado"
        },
        {
            id: "base-dos-dados",
    ...
    economia: [ // Renamed from 'economia' to 'economia e mercado'
        ...
        },
        {
            ...
            // TODO: This link is failing with an SSL error.
    ...
    emprego: [
        {
            ...
            link: "https://www.gov.br/trabalho-e-emprego/pt-br/assuntos/estatisticas-trabalho/caged"
        },
        {
            id: "rais",
        ...
        },
        {
            ...
            // TODO: This link is returning a 403 error.
    ...
    seguranca: [ // Renamed from 'seguranca' to 'Segurança e Justiça'
        ...
        },
        {
            ...
            link: "https://www.cnj.jus.br/estatistica/"
        },
        ...
        { // New from HTML (Judiciais)
            ...
            // TODO: This link is blocking automated requests.
    ...
    transparencia: [ // Renamed from 'transparencia' to 'Transparência, Controle e Administração Pública'
        ...
        { // New from HTML (Administração)
            ...
            link: "https://www.gov.br/ouvidorias/pt-br/cidadao/painel-resolveu"
        },
        ...
        { // New from HTML (Transparência)
            ...
            // TODO: This link is returning a 403 error.
            link: "https://www.gov.br/cgu/pt-br/assuntos/transparencia-publica/escala-brasil-transparente-360"
        }
    ],
    ...
    pesquisas: [ // New Section (Non-IBGE)
        {
            ...
            typeClass: "bg-blue-100 text-blue-800",
            description: "Banco de dados de pesquisas de opinião pública da Unicamp, que resgata, organiza e armazena pesquisas por amostragemizadas no Brasil desde a década de 1990, incluindo pesquisas eleitorais e comportamentais.",
            info: [
    ...
    cultura: [ // New Section
        {
            ...
            link: "https://www.gov.br/cultura/pt-br/acesso-a-informacao/dados-abertos-1"
        },
        {
            id: "sniic",
    ...
    tecnologia: [ // New Section
        ...
        },
        {
            ...
            link: "https://www.gov.br/gestao/pt-br/inova"
        },
        {
            id: "dcti",
