                  ...
                  <div className="card-content">
                    ...
                    <div className="card-footer">
                      {(() => {
                        ...
                        const linkUrl = hasLink ? source.url : `https://www.google.com/search?q=${encodeURIComponent(source.name)}`;
                        const linkText = hasLink ? `Acessar ${source.access_type ? `(${source.access_type})` : 'Base'}` : "Pesquisar no Google";
                        const iconClass = hasLink ? 'fas fa-external-link-alt' : 'fas fa-search';

                        return (
                          <a href={linkUrl} target="_blank" rel="noopener noreferrer" className="card-link-button">
                            <i className={`${iconClass} link-icon`}></i>
                            {linkText}
                          </a>
                        );
                      })()}
